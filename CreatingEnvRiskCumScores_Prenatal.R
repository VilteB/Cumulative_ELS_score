...
Prenatal_LifeEvents <- data.frame(IDM, # add mothers ID here (find the equivalent term within ALSPAC)
...
Prenatal_ContextualRisks  <- data.frame(IDM, # add mothers ID here,
...
Prenatal_ParentalRisks  <- data.frame(IDM, # add mothers ID here,
...
Prenatal_Parental_NoSubUse <- data.frame(IDM, # add mothers ID here,
                                            b577a_rec, # In trouble with the law since PREG
                                            b586a_rec, # PTNR in trouble with law since PREG
                                            b597a_rec, # Attempted suicide since PREG
                                            b598a_rec, # Convicted of an offence since PREG
...
Prenatal_MH_LifestyleRisks_NoMI <- data.frame(IDM, # add mothers ID here,
                                                 b577a_rec, # In trouble with the law since PREG
                                                 b586a_rec, # PTNR in trouble with law since PREG
                                                 b597a_rec, # Attempted suicide since PREG
                                                 b598a_rec, # Convicted of an offence since PREG
...
Prenatal_InterpersonalRisks <- data.frame(IDM, # add mothers ID here,
...
write.csv(prenatal_summary, file = "prenatal_stress_summary.csv", row.names = FALSE, quote = FALSE)
